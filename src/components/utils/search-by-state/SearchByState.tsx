...
const SearchByState: React.FC<ISearchByState> = () => {
  return (
    <div className="mt-[22rem] 2xl:mt-[25rem]">

      <p className="text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl text-neutral-700 mb-5">Szukaj podopiecznych po <span className="text-primary-300 font-bold">województwie</span></p>
      <div className="grid gap-10 md:gap-14 lg:gap-20 pt-5 md:pt-10 text-center content-center grid-cols-2 sm:grid-cols-3 lg:w-full">
