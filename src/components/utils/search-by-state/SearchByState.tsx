...
const SearchByState: React.FC<ISearchByState> = () => {
  return (
    <div className="mt-[22rem] 2xl:mt-[25rem] min-h-screen">
      <p className="text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl text-neutral-700 mb-5">
        Szukaj podopiecznych po{' '}
        <span className="text-primary-300 font-bold">województwie</span>
      </p>
